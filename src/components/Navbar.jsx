    ...
    <header className='shadow sticky h-[85px] md:h-auto top-0 z-10 bg-gradient-to-t from-[rgb(0,6,22)] to-[rgb(17,50,100)] backdrop-blur-md border-b border-gray-600'>
        <nav className='lg-px-8 px-4 py-2 pl-0 w-full'>
            ...
            >
                ...
                <div className='pl-5 text-3xl font-semibold bg-gradient-to-r from-gray-400 via-gray-300 to-white bg-clip-text text-transparent'>IT Consumables</div>
                ...
                {/* <div
                    ref={menuRef}
                    className={`
                        md:flex flex-col md:flex-row md:space-x-10 md:items-center 
                        w-[100vw] md:w-auto overflow-hidden bg-blue-300 md:bg-transparent md:relative absolute left-0 top-[85px] z-0
                ...
                > */}
                        ...
                        {/* <ul className={`flex flex-col font-medium md:flex-row md:space-x-10 md:items-center md:mr-5 transition-all duration-300 ease-in-out ${isOpen ? 'mt-4' : 'mt-0'}`}> */}
                            <li>
                            ...
                            {/* <li>
                                <NavLink to="/Products" className={({isActive}) => `${isActive?" text-white border-b md:border-0 md:scale-120 md:hover:border-b-0":"lg:border-0 text-gray-100"} block py-2 pr-2 pl-1 duration-200 hover:bg-transparent md:hover:border-b lg:p-0`}>
                                    Products
                                </NavLink>
                            </li> */}
                             <li>
                            ...
                            {/* <li>
                                <NavLink to="/PurchaseOrders" className={({isActive}) => `${isActive?" text-white border-b md:border-0 md:scale-120 md:hover:border-b-0":"lg:border-0 text-gray-100"} block py-2 pr-2 pl-1 duration-200 hover:bg-transparent md:hover:border-b lg:p-0`}>
                                    PurchaseOrders
                                </NavLink>
                            </li> */}
                            <li>
                                <NavLink to="/IssueRecords" className={({isActive}) => `${isActive?" text-white border-b md:border-0 md:scale-120 md:hover:border-b-0":"lg:border-0 text-gray-100"} block py-2 pr-2 pl-1 duration-200 hover:bg-transparent md:hover:border-b lg:p-0`}>
                                    Issue Records
                                </NavLink>
                            </li>
                            {/* <li>
                                <NavLink to="/Suppliers" className={({isActive}) => `${isActive?" text-white border-b md:border-0 md:scale-120 md:hover:border-b-0":"lg:border-0 text-gray-100"} block py-2 pr-2 pl-1 duration-200 hover:bg-transparent md:hover:border-b lg:p-0`}>
                                    Suppliers
                                </NavLink>
                            </li> */}
